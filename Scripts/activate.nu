...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\sanch\Documents\Code\Python\Pygame\Platformer'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\sanch\Documents\Code\Python\Pygame\Platformer\Scripts\deactivate.nu'
